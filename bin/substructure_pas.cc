...
int main(int argc, char** argv)
{
  ...
  */
  ...
  stream.select("patJetHelper_selectedPatJetsCA8CHSwithQjets.C2beta05", jethelperCA8_C2beta05);
  stream.select("patJetHelper_selectedPatJetsCA8CHSwithQjets.C2beta10", jethelperCA8_C2beta10);
  ...
  stream.select("patJetHelper_selectedPatJetsCA8CHSwithQjets.C2beta25", jethelperCA8_C2beta25);
